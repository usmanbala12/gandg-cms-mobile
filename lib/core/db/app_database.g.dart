...
class $ProjectAnalyticsTable extends ProjectAnalytics
  ...
  late final GeneratedColumn<int> reportsCount = GeneratedColumn<int>(
      ...
      requiredDuringInsert: false,
      defaultValue: const Constant(0));
  static const VerificationMeta _requestsPendingMeta =
      const VerificationMeta('requestsPending');
  @override
  late final GeneratedColumn<int> requestsPending = GeneratedColumn<int>(
      'requests_pending', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultValue: const Constant(0));
  static const VerificationMeta _openIssuesMeta =
      const VerificationMeta('openIssues');
  @override
  late final GeneratedColumn<int> openIssues = GeneratedColumn<int>(
      'open_issues', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultValue: const Constant(0));
  static const VerificationMeta _reportsTimeseriesMeta =
      const VerificationMeta('reportsTimeseries');
  @override
  late final GeneratedColumn<String> reportsTimeseries =
      GeneratedColumn<String>('reports_timeseries', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _requestsByStatusMeta =
      const VerificationMeta('requestsByStatus');
  @override
  late final GeneratedColumn<String> requestsByStatus = GeneratedColumn<String>(
      'requests_by_status', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _recentActivityMeta =
      const VerificationMeta('recentActivity');
  @override
  late final GeneratedColumn<String> recentActivity = GeneratedColumn<String>(
      'recent_activity', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _createdAtMeta =
      const VerificationMeta('createdAt');
  @override
  ...
  @override
  VerificationContext validateIntegrity(Insertable<ProjectAnalytic> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('project_id')) {
  ...
  ProjectAnalytic map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ProjectAnalytic(
      ...
      requestsPending: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}requests_pending'])!,
      openIssues: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}open_issues'])!,
      reportsTimeseries: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}reports_timeseries']),
      requestsByStatus: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}requests_by_status']),
      recentActivity: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}recent_activity']),
      createdAt: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}created_at'])!,
      updatedAt: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}updated_at'])!,
...
class ProjectAnalytic extends DataClass implements Insertable<ProjectAnalytic> {
  ...
  factory ProjectAnalytic.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ProjectAnalytic(
      projectId: serializer.fromJson<String>(json['projectId']),
      ...
      reportsTimeseries:
          serializer.fromJson<String?>(json['reportsTimeseries']),
  ...
  ProjectAnalytic copyWith(
      ...
      ProjectAnalytic(
        ...
        requestsByStatus: requestsByStatus.present
            ...
            : this.requestsByStatus,
        recentActivity:
            recentActivity.present ? recentActivity.value : this.recentActivity,
        createdAt: createdAt ?? this.createdAt,
        updatedAt: updatedAt ?? this.updatedAt,
      );
  ProjectAnalytic copyWithCompanion(ProjectAnalyticsCompanion data) {
    return ProjectAnalytic(
      ...
      openIssues:
          data.openIssues.present ? data.openIssues.value : this.openIssues,
...
class $ReportsTable extends Reports with TableInfo<$ReportsTable, Report> {
  ...
  late final GeneratedColumn<int> reportDate = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _submissionDataMeta =
      const VerificationMeta('submissionData');
  @override
  late final GeneratedColumn<String> submissionData = GeneratedColumn<String>(
      'submission_data', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _locationMeta =
      const VerificationMeta('location');
  @override
  late final GeneratedColumn<String> location = GeneratedColumn<String>(
      'location', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _mediaIdsMeta =
      const VerificationMeta('mediaIds');
  @override
  late final GeneratedColumn<String> mediaIds = GeneratedColumn<String>(
      'media_ids', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _statusMeta = const VerificationMeta('status');
  @override
  late final GeneratedColumn<String> status = GeneratedColumn<String>(
    ...
    if (data.containsKey('submission_data')) {
      context.handle(
          ...
          submissionData.isAcceptableOrUnknown(
              data['submission_data']!, _submissionDataMeta));
    }
    if (data.containsKey('location')) {
      context.handle(_locationMeta,
          location.isAcceptableOrUnknown(data['location']!, _locationMeta));
  ...
  Report map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Report(
      ...
      reportDate: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}report_date'])!,
      submissionData: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}submission_data']),
      location: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}location']),
      mediaIds: attachedDatabase.typeMapping
...
class Report extends DataClass implements Insertable<Report> {
  ...
  Report copyWith(
      ...
      Report(
        ...
        submissionData:
            submissionData.present ? submissionData.value : this.submissionData,
        location: location.present ? location.value : this.location,
...
class $IssueCommentsTable extends IssueComments
  ...
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _issueLocalIdMeta =
      const VerificationMeta('issueLocalId');
  @override
  late final GeneratedColumn<String> issueLocalId = GeneratedColumn<String>(
      'issue_local_id', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  @override
  VerificationContext validateIntegrity(Insertable<IssueComment> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
    ...
    if (data.containsKey('issue_local_id')) {
      context.handle(
          ...
          issueLocalId.isAcceptableOrUnknown(
              data['issue_local_id']!, _issueLocalIdMeta));
    } else if (isInserting) {
  ...
  IssueComment map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return IssueComment(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      issueLocalId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}issue_local_id'])!,
...
class IssueComment extends DataClass implements Insertable<IssueComment> {
  ...
  @override
  int get hashCode => Object.hash(id, issueLocalId, authorId, body, createdAt,
      updatedAt, deletedAt, serverId, serverCreatedAt, serverUpdatedAt, status);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $IssueHistoryTable extends IssueHistory
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, issueId, action, field, oldValue, newValue, authorId, timestamp];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<IssueHistoryData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
...
class IssueHistoryData extends DataClass
  ...
  factory IssueHistoryData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return IssueHistoryData(
      id: serializer.fromJson<String>(json['id']),
...
class $IssueMediaTable extends IssueMedia
  ...
  @override
  VerificationContext validateIntegrity(Insertable<IssueMediaData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
...
class IssueMediaData extends DataClass implements Insertable<IssueMediaData> {
  ...
  factory IssueMediaData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return IssueMediaData(
      id: serializer.fromJson<String>(json['id']),
  ...
  @override
  int get hashCode => Object.hash(id, issueId, localPath, thumbnailPath,
      mimeType, sizeBytes, serverId, serverUrl, uploadStatus);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class MediaFile extends DataClass implements Insertable<MediaFile> {
  ...
  @override
  int get hashCode => Object.hash(id, localPath, projectId, parentType,
      parentId, uploadStatus, mime, size, createdAt, serverId, thumbnailPath);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is MediaFile &&
...
class SyncConflict extends DataClass implements Insertable<SyncConflict> {
  ...
  int get hashCode => Object.hash(id, entityType, entityId, localPayload,
      serverPayload, detectedAt, resolved, resolution, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class Notification extends DataClass implements Insertable<Notification> {
  ...
  @override
  int get hashCode => Object.hash(id, userId, projectId, title, body, type,
      isRead, createdAt, serverId, meta);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ProjectAnalyticsTable projectAnalytics =
      $ProjectAnalyticsTable(this);
  ...
  late final IssueCommentDao issueCommentDao =
      IssueCommentDao(this as AppDatabase);
  late final IssueHistoryDao issueHistoryDao =
      IssueHistoryDao(this as AppDatabase);
...
class $$ProjectAnalyticsTableFilterComposer
  ...
  ColumnFilters<int> get openIssues => $composableBuilder(
      column: $table.openIssues, builder: (column) => ColumnFilters(column));
...
class $$ProjectAnalyticsTableOrderingComposer
  ...
  ColumnOrderings<int> get openIssues => $composableBuilder(
      column: $table.openIssues, builder: (column) => ColumnOrderings(column));
...
class $$ProjectAnalyticsTableAnnotationComposer
  ...
  GeneratedColumn<int> get requestsPending => $composableBuilder(
      column: $table.requestsPending, builder: (column) => column);

  GeneratedColumn<int> get openIssues => $composableBuilder(
      column: $table.openIssues, builder: (column) => column);

  GeneratedColumn<String> get reportsTimeseries => $composableBuilder(
      column: $table.reportsTimeseries, builder: (column) => column);

  GeneratedColumn<String> get requestsByStatus => $composableBuilder(
      column: $table.requestsByStatus, builder: (column) => column);

  GeneratedColumn<String> get recentActivity => $composableBuilder(
      column: $table.recentActivity, builder: (column) => column);
...
class $$ProjectAnalyticsTableTableManager extends RootTableManager<
    _$AppDatabase,
  ...
  $$ProjectAnalyticsTableTableManager(
      _$AppDatabase db, $ProjectAnalyticsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$ProjectAnalyticsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $ProjectAnalyticsTable,
    ProjectAnalytic,
    $$ProjectAnalyticsTableFilterComposer,
...
class $$ReportsTableFilterComposer
  ...
  ColumnFilters<String> get mediaIds => $composableBuilder(
      column: $table.mediaIds, builder: (column) => ColumnFilters(column));
...
class $$ReportsTableAnnotationComposer
  ...
  GeneratedColumn<String> get submissionData => $composableBuilder(
      column: $table.submissionData, builder: (column) => column);
...
typedef $$IssuesTableProcessedTableManager = ProcessedTableManager<
    ...
    Issue,
    PrefetchHooks Function()>;
typedef $$IssueCommentsTableCreateCompanionBuilder = IssueCommentsCompanion
    Function({
  required String id,
  required String issueLocalId,
  required String authorId,
...
typedef $$IssueCommentsTableUpdateCompanionBuilder = IssueCommentsCompanion
    Function({
  Value<String> id,
  Value<String> issueLocalId,
  Value<String> authorId,
...
class $$IssueCommentsTableFilterComposer
  ...
  ColumnFilters<String> get issueLocalId => $composableBuilder(
      column: $table.issueLocalId, builder: (column) => ColumnFilters(column));
...
class $$IssueCommentsTableAnnotationComposer
  ...
  GeneratedColumn<String> get issueLocalId => $composableBuilder(
      column: $table.issueLocalId, builder: (column) => column);
...
class $$IssueCommentsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $IssueCommentsTable,
    IssueComment,
    $$IssueCommentsTableFilterComposer,
...
typedef $$IssueCommentsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $IssueCommentsTable,
    IssueComment,
    $$IssueCommentsTableFilterComposer,
    ...
    IssueComment,
    PrefetchHooks Function()>;
typedef $$IssueHistoryTableCreateCompanionBuilder = IssueHistoryCompanion
    Function({
  required String id,
  required String issueId,
  required String action,
...
typedef $$IssueHistoryTableUpdateCompanionBuilder = IssueHistoryCompanion
    Function({
  Value<String> id,
  Value<String> issueId,
  Value<String> action,
...
class $$IssueHistoryTableFilterComposer
  ...
  ColumnFilters<String> get issueId => $composableBuilder(
      column: $table.issueId, builder: (column) => ColumnFilters(column));
...
class $$IssueHistoryTableOrderingComposer
  ...
  ColumnOrderings<String> get issueId => $composableBuilder(
      column: $table.issueId, builder: (column) => ColumnOrderings(column));
...
class $$IssueHistoryTableTableManager extends RootTableManager<
    _$AppDatabase,
    $IssueHistoryTable,
    IssueHistoryData,
    $$IssueHistoryTableFilterComposer,
...
typedef $$IssueHistoryTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $IssueHistoryTable,
    IssueHistoryData,
    $$IssueHistoryTableFilterComposer,
    ...
    IssueHistoryData,
    PrefetchHooks Function()>;
typedef $$IssueMediaTableCreateCompanionBuilder = IssueMediaCompanion Function({
  required String id,
  required String issueId,
  required String localPath,
  Value<String?> thumbnailPath,
...
typedef $$IssueMediaTableUpdateCompanionBuilder = IssueMediaCompanion Function({
  Value<String> id,
  Value<String> issueId,
  Value<String> localPath,
  Value<String?> thumbnailPath,
...
class $$IssueMediaTableTableManager extends RootTableManager<
    _$AppDatabase,
    $IssueMediaTable,
    IssueMediaData,
    $$IssueMediaTableFilterComposer,
...
typedef $$IssueMediaTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $IssueMediaTable,
    IssueMediaData,
    $$IssueMediaTableFilterComposer,
